<?php include("header.php") ?>
        ...
        <div class="login_left">
            <form name="form1" method="post" action="login.aspx?FromUrl=http%3a%2f%2fwww.ppdai.com%2faccount1%2fdefault.aspx" id="form1">
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="">
</div>

<div>

	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWBQKdw+GdCAKl1bKzCQK1qbSRCwKC3IeGDAKQo8KrDTUBjymqoFXOiXbvBw8tL+JUzdEB">
</div>
