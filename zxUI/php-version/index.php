...
<div class="pull-left index_center_leftnav l">
            ...
            <div class="list_nav">
                        ...
                        <div class="nowlistnav">
                            <div class="l img_nav">
                                <img style="width: 50px; height: 50px;" src="http://avatar.ppdai.com/crop/baac8696-c65d-4776-80de-60c9db6bf936.png_120"></div>
                            <div>
                                <a href="/list/293862">
                                    慧聪优质商家信用贷 沈阳****公司 经营借款</a>
                                <div>
                                    <ul class="l nowlist_2nav">
                                        <li>借款金额：<span class="color3">¥150,000</span></li>
                                        <li><span class="l">信用等级：</span><a href="/credit/sunzhihe" title="借入信用：0分(HR)"><img src="http://static.ppdai.com/skin/images/xinxin0.gif" width="16" height="16" align="middle" alt="">(HR)</a></li>
                                    </ul>
                                    <ul class="l" style="width: 280px; line-height: 20px; margin-top: 3px;">
                                        <li><span class="l">年利率：</span>
                                            <label class="color3 l" style="width: 97px; display: block;">
                                            ...
                                            借款期限：6个月</li>
                                        <li><span class="l">借款进度：</span> <span class="loading" style="border: 1px solid #E2E2E2;
                                            background-color: rgb(226,226,226);"><span style="width: 26%">
                                            </span></span><span class="l" style="margin-right: 5px;">
                                                26%</span>已完成252笔投标</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="nowlistnav">
                            <div class="l img_nav">
                                <img style="width: 50px; height: 50px;" src="http://avatar.ppdai.com/crop/81c2ecae-d3a1-4945-b327-726f14d571a7.png_120"></div>
                            <div>
                                <a href="/list/293086">
                                    淘宝5冠大卖家  旺季备货</a>
                                <div>
                                    <ul class="l nowlist_2nav">
                                        <li>借款金额：<span class="color3">¥150,000</span></li>
                                        <li><span class="l">信用等级：</span><a href="/credit/jianghua58" title="借入信用：35分(E)"><img src="http://static.ppdai.com/skin/images/xinxin1.gif" width="16" height="16" align="middle" alt="">(E)</a></li>
                                    </ul>
                                    <ul class="l" style="width: 280px; line-height: 20px; margin-top: 3px;">
                                        <li><span class="l">年利率：</span>
                                            <label class="color3 l" style="width: 97px; display: block;">
                                            ...
                                            借款期限：6个月</li>
                                        <li><span class="l">借款进度：</span> <span class="loading" style="border: 1px solid #E2E2E2;
                                            background-color: rgb(226,226,226);"><span style="width: 54%">
                                            </span></span><span class="l" style="margin-right: 5px;">
                                                54%</span>已完成333笔投标</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background: url(http://static.ppdai.com/skin/images/dian.png) repeat-x;
                            height: 1px; margin-top: 10px; margin-bottom: 18px; ">
                        </div>
						   <div class="nowlistnav">
                            <div class="l img_nav">
                                <img style="width: 50px; height: 50px;" src="http://avatar.ppdai.com/crop/baac8696-c65d-4776-80de-60c9db6bf936.png_120"></div>
